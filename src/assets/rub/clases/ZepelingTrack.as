...
public class ZepelingTrack extends MovieClip{
    ...
    private var _duplicado:Zepeling;
    private var _apoyos:String;


    public function ZepelingTrack() {
        _duplicado  = new Zepeling();
    }
    ...
    private function cargarApoyo():void
    {
        ...
        cn.connect(GATEWAY);
        cn.call('ContactService.cargarApoyo', new Responder(respuesta));
    }
    ...
    private function respuesta(datos:Object):void
    {
        ...
        _apoyos = String(datos);
        _duplicado.texto_txt.text = _apoyos;
    }
